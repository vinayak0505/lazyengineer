...
public class Notes extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<PdfDocument>>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isConnected) {
            ...
            gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    ImageView size = (ImageView) view.findViewById(R.id.imageView);
                    size.setImageResource(R.drawable.ic_round_arrow_downward_24);
                    mView[m] = view;
                    m++;
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent text1Intent = new Intent( Notes.this,MainActivity.class);
        ...
        BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(action)){
                    ...
                    ImageView imageView1 = (ImageView) mView[n].findViewById(R.id.imageView);
                    n++;
                    imageView1.setImageResource(R.drawable.ic_baseline_picture_as_pdf_24);
    ...
    private Boolean IntentToOpenDocument(Uri uri) {
        ...
        try {
            getApplicationContext().startActivity(openAttachmentIntent);
            return true;
    ...
    private long checkUriFromDatabase(long id) {
        ...
        try{
            ...
            Log.e(TAG, "checkDownloaded: error occuring please check"+ uriId );
        } finally {
            db.close();
            mDbHelper.close();
        }
